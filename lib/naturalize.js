...
export async function deliverWithRetry(dispatcher, content, ttsCtx, log) {
...
export function createNaturalize({ cfg, engine, persona, socialMemory, observedStore, mood, log }) {
