...
export const replyContextQueue = new Map(); // `${sessionKey}|${senderId}` → [{body, sender, textNorm, msgId, ts}]
...
export const speakPathBySession = new Map(); // sessionKey → "dm" | "reply" | "hard" | "llm" (last speak path)
