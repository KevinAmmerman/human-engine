...
export function buildDecidePrompt({ transcript, persona, voiceCard, agentName, mediaKind, memoryContext, threadContext, v2Contract, language }) {
...
export function buildSplitPrompt({ draft, transcript, persona, voiceCard, styleConstraints, maxBubbles, replyTarget, language }) {
  const pack = languagePack(language);
  const antiTell = [
