...
export function createLocalEngine({ cfg, llm, timing, log }) {
  ...
  async function decide({ sessionKey, messages, systemPrompt, isDM, hasMedia, mediaKind, transcript, persona, voiceCard, agentName, prompt, agentContactIds, replyToAgent, agentAliases }) {
    ...
    const decidePrompt = buildDecidePrompt({ transcript, persona, voiceCard, agentName, mediaKind });
