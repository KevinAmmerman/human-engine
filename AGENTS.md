...
This repo has agent-optimized documentation in `wiki/`. Start here:
[wiki/quickstart.md](wiki/quickstart.md). When the wiki is stale (check
`wiki/.last-update.json`), run `wiki update`.
<!-- wiki-pointer end -->
