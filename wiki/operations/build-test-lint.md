...
| Test | `npm test` | 783 pass, 0 fail |
| Parity matrix | `node test/parity-matrix.mjs --check` | `42/42 covered` |
...
- **Parity matrix**: `test/parity-matrix.mjs` — 42 behavioral checks, must stay covered on every change
