...
- **Test files**: `test/*.test.js` — 27 test files covering all modules
...
- **Parity matrix**: `test/parity-matrix.mjs` — 36 behavioral checks, must stay covered on every change
