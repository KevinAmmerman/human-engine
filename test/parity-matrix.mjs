...
const MATRIX = [
  ...
  { id: 6,  behavior: "Slash commands bypass gate",
    tags: ["command bypass"] },
  { id: 7,  behavior: "stay_silent → block + [Name] text observed buffer",
    tags: ["stay_silent", "block", "observed"] },
  ...
  { id: 10, behavior: "Group fail-closed (engine null → silent)",
    tags: ["group fail-closed", "fail-closed"] },
