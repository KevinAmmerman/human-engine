...
const MATRIX = [
  ...
  { id: 6,  behavior: "Slash commands bypass gate",
    tags: ["command bypass"] },
  { id: 7,  behavior: "stay_silent → before_agent_run block (turn stopped, cheap) + message_sending cancels the block text outbound (no user-facing text in chat)",
    tags: ["stay_silent", "block", "observed", "onMessageSending"] },
  ...
  { id: 10, behavior: "Group fail-closed → before_agent_run block (engine null) + message_sending cancels the block text outbound",
    tags: ["group fail-closed", "block", "onMessageSending"] },
  { id: 11, behavior: "Speak → epoch stashed per sessionKey; consumed once",
    tags: ["stashes draft", "epoch exists"] },
