...
const MATRIX = [
  ...
  { id: 6,  behavior: "Slash commands bypass gate",
    tags: ["command bypass"] },
  { id: 7,  behavior: "stay_silent → silent claim ({handled:true}) + observed buffer",
    tags: ["stay_silent", "handled: true", "observed"] },
  ...
  { id: 10, behavior: "Group fail-closed → silent claim ({handled:true})",
    tags: ["group fail-closed", "handled: true"] },
